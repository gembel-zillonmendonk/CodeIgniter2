<div class="tabs">
    ...
    <div id="tabs-1">
        <div class="accordion">
            ...
            <div></div>
            <h3 href="<?php echo site_url('/vendor/view_form/ep_vendor_jamsostek') ?>">KEPESERTAAN JAMSOSTEK</h3>
            <div></div>
        </div>
    </div>
    ...
    <div id="tabs-2">
        <div class="accordion">
            ...
            <div></div>
            <h3 href="<?php echo site_url('/vendor/view_form/ep_vendor_npwp') ?>">NPWP</h3>
            <div></div>
            <h3 href="<?php echo site_url('/vendor/view_form/ep_vendor_mitra') ?>">JENIS MITRA KERJA</h3>
            <div></div>
