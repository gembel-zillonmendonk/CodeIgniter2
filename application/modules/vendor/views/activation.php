...
<div class="tabs">
    <div class="accordion">
        <h3 href="<?php echo site_url('/crud/form/ep_vendor_dokumen') ?>">CHEKLIST DOKUMEN</h3>
        <div></div>
        <h3 href="<?php echo site_url('/crud/grid_form/ep_vendor_dokumen_pendukung') ?>">DOKUMEN PENDUKUNG</h3>
        <div></div>
    </div>
</div>
<p>
