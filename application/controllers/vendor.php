...
//$this->session->set_userdata('user_id', '512');
        ...
        $this->rules = array(
            ...
            '1' => array(// tabs-2
                ...
                array('model' => 'ep_vendor_tdp', 'label' => 'TDP', 'rules' => 'required', 'where' => $where),
            //array('model' => 'ep_vendor_agen', 'label' => 'SURAT KEAGENAN/DISTRIBUTORSHIP (OPSIONAL)', 'rules' => 'hasOne', 'where' => $where . " AND TIPE = 'AGEN'"),
            //array('model' => 'ep_vendor_importir', 'label' => 'ANGKA PENGENAL IMPORTIR (OPSIONAL)', 'rules' => 'hasOne', 'where' => $where . " AND TIPE = 'IMPORTIR'"),
            ),
            '2' => array(// tabs-3
